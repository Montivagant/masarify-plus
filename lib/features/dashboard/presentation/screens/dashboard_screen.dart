...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Theme revamp v7.5: quick-access icons (AI chat, Settings) lifted
    // out of layout flow into a Positioned overlay. No header zone, no
    // top bar — just two floating circular buttons over the gradient,
    // visually independent of the BalanceHeader content beneath them.
    return Scaffold(
      body: Stack(
        children: [
          SafeArea(
          ...
          // ── Floating quick-access icons (overlay, no layout space) ──
