...
class AiChatService {
  ...
  String _buildSystemPrompt(FinancialContext ctx) {
    ...
    return '⚡ LANGUAGE RULE (HIGHEST PRIORITY): You MUST respond in $langName. Every word of your reply must be in $langName.\n'
        ...
        '\n'
        'UPDATE/DELETE: For updates, include the original title+amount to identify the item, plus new_* fields for what to change. For deletes, include enough info to identify the item (title for goals/recurring, category for budgets).\n'
        '\n'
  ...
  String _buildArabicPrompt({
    ...
    return '⚡ LANGUAGE RULE (HIGHEST PRIORITY): You MUST respond in Arabic. Every word of your reply must be in Arabic.\n'
        ...
        '\n'
        'تعديل/حذف: للتعديل، اشمل title+amount الأصلي لتحديد العنصر + حقول new_* للتغييرات. للحذف، اشمل معلومات كافية لتحديد العنصر (title للأهداف/الاشتراكات، category للميزانيات).\n'
        '\n'
