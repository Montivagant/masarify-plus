...
Reference full template: `D:/Masarify-Plus/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Masarify-Plus/.claude/get-shit-done/templates/state.md`.
