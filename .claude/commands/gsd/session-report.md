...
<execution_context>
@D:/Masarify-Plus/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @D:/Masarify-Plus/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
