  ...
  group('GoalKeywordMatcher', () {
    group('matches()', () {
      test('matches Arabic keyword in text', () {
        final matcher = GoalKeywordMatcher(keywords: ['سفر', 'رحلة']);
    ...
    group('firstMatch()', () {
      ...
      test('returns null when no match', () {
        final matcher = GoalKeywordMatcher(keywords: ['سفر']);
